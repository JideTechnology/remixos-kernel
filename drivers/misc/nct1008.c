...
struct i2c_client *nct1008_client= NULL;
...
int nct1008_temp_to_battery(void)
{
    ...
    pdata = nct1008_client->dev.platform_data;

    value = nct1008_read_reg(nct1008_client, LOCAL_TEMP_RD);
    if (value < 0)
        return 0;

    temperature = value_to_temperature(pdata->ext_range, value) - 10;
...
EXPORT_SYMBOL(nct1008_temp_to_battery);
