...
#include <linux/pi3usb30532_mux.h>
#include <linux/usb_typec_phy.h>
#include <linux/extcon.h>
#include <linux/acpi.h>

/* I2C control register's offsets */
#define PI3USB30532_SLAVE_ADDR          0x00
#define PI3USB30532_VENDOR_ID           0x01
#define PI3USB30532_SEL_CTRL            0x02

#define CONF_MASK                       0x07

#define DEV_NAME "pi3usb30532_mux"
...
static int pi3usb30532_mux_sel_ctrl(struct pi3usb30532_mux *chip,
					enum pi3usb30532_mux_conf conf)
{
	int ret = 0;

	dev_info(&chip->client->dev, "%s %d\n", __func__, conf);
	ret = pi3usb30532_mux_modify_reg(chip->client,
						PI3USB30532_SEL_CTRL,
						(u8) CONF_MASK,
						(u8) conf);
	if (ret)
...
static void pi3usb30532_mux_event_worker(struct work_struct *work)
{
	...
	orientation = typec_get_cc_orientation();
				...
				const struct i2c_device_id *id)
{
	...
	pi3usb30532_vid = pi3usb30532_mux_read_reg(client,
				PI3USB30532_VENDOR_ID);
	if (pi3usb30532_vid < 0) {
		dev_err(&client->dev,
			"Error (%d) in reading PI3USB30532_VENDOR_ID\n",
			pi3usb30532_vid);
		return pi3usb30532_vid;
	}
...
MODULE_DESCRIPTION("PI3USB30532 Mux Driver");
MODULE_LICENSE("GPL");
