...
static int pwm_backlight_update_status(struct backlight_device *bl)
{
	...
	//printk(KERN_DEBUG "%s backlight:%d\n", brightness);
...
//	printk("liucong the pwm_backlight_update_status brightness is %d \n",brightness);
