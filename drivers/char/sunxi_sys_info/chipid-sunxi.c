...
int sunxi_smc_writel(phys_addr_t addr, u32 value)
{
	return invoke_smc_fn(ARM_SVC_WRITE_SEC_REG_AARCH64, addr, 0, 0);
}

int sunxi_smc_probe_secure(void)
{

	return invoke_smc_fn(ARM_SVC_EFUSE_PROBE_SECURE_ENABLE_AARCH64, 0, 0, 0);
}
#endif
