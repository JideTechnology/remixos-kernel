...
static int goodix_ts_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    GTP_INFO("BIOS I2C Address: 0x%02x", client->addr);
//	client->addr = 0x5D;//0x14; //hard code I2C addr
	GTP_INFO("GTP I2C Address hard code: 0x%02x", client->addr);
...
static const struct acpi_device_id goodix_acpi_match[] = {
	{"GODX9110", 0}, //Hack to use default SILEAD touch ID
	{ },
};
#endif
