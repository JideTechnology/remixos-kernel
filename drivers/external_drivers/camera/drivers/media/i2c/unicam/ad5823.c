...
int ad5823_vcm_power_up(struct v4l2_subdev *sd)
{
	...
	if (ad5823_dev.vcm_mode != AD5823_DIRECT) {
		...
		/* set the VCM_TIME */
		ret = ad5823_i2c_write(client,AD5823_REG_VCM_MOVE_TIME,	AD5823_DEF_TIME);

		/* set the VCM_THRESHOLD */
		ret = ad5823_i2c_write(client,AD5823_REG_VCM_THRESHOLD_LSB, AD5823_DEF_THRESHOLD);
...
{
	/* set vcm mode to ARC RES1 */
	ad5823_dev.vcm_mode = AD5823_ARC_RES0;
