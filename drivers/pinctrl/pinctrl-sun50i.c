...
#define SUNXI_R_PIO_VBASE	(0Xf1f02c00)
#define SUNXI_IRQ_EINTB		(43)
#define SUNXI_IRQ_EINTG         (47)
#define SUNXI_IRQ_EINTH		(49)
#define SUNXI_IRQ_EINTL		(78)
#define SUNXI_IRQ_MAX		(256)

static struct sunxi_desc_pin sun50i_w1_pins[] = {
...
static struct sunxi_pin_bank sun50i_w1_banks[] = {
	SUNXI_PIN_BANK(SUNXI_PIO_VBASE,   SUNXI_PB_BASE, 10, SUNXI_EINT_TYPE_GPIO, "PB", SUNXI_IRQ_EINTB),
	SUNXI_PIN_BANK(SUNXI_PIO_VBASE,   SUNXI_PC_BASE, 19, SUNXI_EINT_TYPE_NONE, "PC", SUNXI_IRQ_MAX  ),
	SUNXI_PIN_BANK(SUNXI_PIO_VBASE,   SUNXI_PD_BASE, 25, SUNXI_EINT_TYPE_NONE, "PD", SUNXI_IRQ_MAX  ),
...
struct sunxi_pinctrl_desc sunxi_pinctrl_data = {
	.pins   = sun50i_w1_pins,
	.npins  = ARRAY_SIZE(sun50i_w1_pins),
	.banks  = sun50i_w1_banks,
	.nbanks = ARRAY_SIZE(sun50i_w1_banks),
};
