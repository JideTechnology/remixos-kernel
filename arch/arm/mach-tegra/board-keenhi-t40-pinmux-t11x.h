/*
 * arch/arm/mach-tegra/board-keenhi_t40-pinmux-t11x.h
 *
...
static __initdata struct tegra_pingroup_config keenhi_t40_pinmux_common[] = {
	...
	DEFAULT_PINMUX(ULPI_DIR,      SPI1,        NORMAL,    NORMAL,   OUTPUT),
	...
	DEFAULT_PINMUX(GMI_A17,       UARTD,       NORMAL,    NORMAL,   OUTPUT),
...
//	DEFAULT_PINMUX(KB_ROW8,       KBC,         PULL_UP,   NORMAL,   INPUT),
	...
	GPIO_PINMUX(GPIO_PU1, NORMAL, NORMAL, OUTPUT, DISABLE),
	...
	GPIO_PINMUX(ULPI_STP, NORMAL, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(GMI_CS6_N, NORMAL, NORMAL, OUTPUT, DISABLE),
...
static struct gpio_init_pin_info init_gpio_mode_keenhi_t40_common[] = {
	...
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PP1, true, 0),
	...
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PO0, true, 0),//panel enable bl
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PO7, true, 0),//panel enable bl
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PN2, true, 0),//wacom interrupt
	...
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PG4, true, 0),//for ram code0
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PG5, true, 0),//for ram code1
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PY3, false, 1),
