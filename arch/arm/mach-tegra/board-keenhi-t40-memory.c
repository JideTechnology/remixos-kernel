...
static struct tegra11_emc_pdata *keenhi_t40_get_emc_data(void)
{
	return &e1545_h5tc4g63mfr_pba_T40S_pdata;
}

int __init keenhi_t40_emc_init(void)
{
	tegra_emc_device.dev.platform_data = keenhi_t40_get_emc_data();
