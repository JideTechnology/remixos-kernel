...
//	}
	...
	if (panel) {
		...
		if (panel->init_dc_out && panel->select_dc_24bit)
			panel->select_dc_24bit(&macallan_disp1_out);
...
int __init macallan_panel_init(void)
{
	...
	macallan_disp1_fb_data.flags |=  TEGRA_FB_DISABLE_BLANK;
