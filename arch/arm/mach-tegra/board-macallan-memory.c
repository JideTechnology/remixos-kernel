...
static struct tegra11_emc_table e1545_h5tc4g63mfr_pba_T40S_table[] = {
	...
	},
	{
		...
		},
		{
			...
			0x00054000, /* EMC_DLL_XFORM_DQ1 */
			0x00054000, /* EMC_DLL_XFORM_DQ2 */
			0x00054000, /* EMC_DLL_XFORM_DQ3 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS1 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS2 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS3 */
			0x00000000, /* EMC_DLL_XFORM_QUSE1 */
	...
	},
	{
		...
		},
		{
			...
			0x00249249, /* EMC_XM2DQSPADCTRL4 */
			0x20820800, /* EMC_XM2DQSPADCTRL3 */
			0x0003c000, /* EMC_DLL_XFORM_DQ0 */
			0xa0f10f0f, /* EMC_AUTO_CAL_CONFIG */
			0x0004c000, /* EMC_DLL_XFORM_ADDR0 */
			0x00000c0c, /* EMC_XM2CLKPADCTRL2 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS0 */
			0x00000000, /* EMC_DLL_XFORM_ADDR1 */
			0x0004c000, /* EMC_DLL_XFORM_ADDR2 */
			0x00030000, /* EMC_DLL_XFORM_DQS1 */
			0x00030000, /* EMC_DLL_XFORM_DQS2 */
			0x00030000, /* EMC_DLL_XFORM_DQS3 */
			0x0003c000, /* EMC_DLL_XFORM_DQ1 */
	...
	},
	{
		...
		11,         /* number of up_down_regs */
		{
			...
			0x00000007, /* MC_EMEM_ARB_TIMING_W2R */
			0x07060202, /* MC_EMEM_ARB_DA_TURNS */
...
#endif
/*---------------------------jpad mem----------------------------------------*/
static struct tegra11_emc_table e1545_h5tc4g63mfr_jpad_T40S_table[] =
{
	{
		0x42,       /* Rev 4.0.3 */
		12750,      /* SDRAM frequency */
...
static int hwrev = 0;
int tegra11_get_hwrev(void)
{
	int hw_rev=0;
	hw_rev|=((gpio_get_value(TEGRA_GPIO_PQ3) ? 1 : 0) << 0);
	hw_rev|=((gpio_get_value(TEGRA_GPIO_PS0) ? 1 : 0) << 1);
	hw_rev|=((gpio_get_value(TEGRA_GPIO_PS2) ? 1 : 0) << 2);
	if (!hwrev) {
		printk(">>>>>>>>>>>>>>>>>>>>>>show HW REV: %d<<<<<<<<<<<<<<<<<<\n", hw_rev);
		hwrev++;
	}
	return hw_rev;
}
...
static struct tegra11_emc_pdata e1545_h5tc4g63mfr_jpad_T40S_pdata = {
	.description = "e1545_h5tc4g63mfr_jpad_T40S",
	.tables = e1545_h5tc4g63mfr_jpad_T40S_table,
	.num_tables = ARRAY_SIZE(e1545_h5tc4g63mfr_jpad_T40S_table),
};
static struct tegra11_emc_pdata *macallan_get_emc_data(void)
{
	if(tegra11_get_hwrev()==7)
	return &e1545_h5tc4g63mfr_jpad_T40S_pdata;
	else
