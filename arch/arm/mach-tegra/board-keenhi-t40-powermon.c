/*
 * arch/arm/mach-tegra/board-keenhi_t40-powermon.c
 *
...
static struct i2c_board_info keenhi_t40_i2c1_ina_board_info[] = {
#if 0
	[INA_I2C_ADDR_40] = {
...
int __init keenhi_t40_pmon_init(void)
{
	i2c_register_board_info(1, keenhi_t40_i2c1_ina_board_info,
		ARRAY_SIZE(keenhi_t40_i2c1_ina_board_info));
