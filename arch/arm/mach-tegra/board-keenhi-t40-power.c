...
struct bq2419x_charger_platform_data macallan_bq2419x_charger_pdata = {
	...
	.bq24190_reg00 = 0x4c,//Configure Input voltage limit to 4.6v, and charging current to 1200mA.
	.bq24190_reg02 = 0x7e,// Configure Fast Charge Current Control to 2.496A	
#else
...
#ifdef CONFIG_BATTERY_CW2015
static char cw2015_anran8100_tb610n_config_info[SIZE_BATINFO] = {
	0x17,0x64,0x5B,0x5E,0x60,0x64,0x5C,0x5E,0x56,0x5E,0x72,0x4C,0x4E,
	0x4B,0x43,0x40,0x3B,0x35,0x35,0x32,0x3A,0x3F,0x41,0x41,0x37,0x2F,
	0x0D,0x71,0x4A,0x73,0x8A,0x9B,0xA4,0x9E,0x97,0x9C,0x48,0x1C,0xBB,
	0x10,0x06,0x34,0x52,0x87,0x8F,0x91,0x94,0x52,0x82,0x8C,0x92,0x96,
	0x79,0x99,0x8E,0xCB,0x2F,0x7D,0x72,0xA5,0xB5,0xC1,0xC3,0x09
};
...
PALMAS_REGS_PDATA(ldo1, 1050,  1050, palmas_rails(smps7), 1, 0, 1, 0,
	0, PALMAS_EXT_CONTROL_NSLEEP, 0, 0, 0);
PALMAS_REGS_PDATA(ldo2, 1200,  1200, palmas_rails(smps7), 1, 1, 1, 0,
	0, 0, 0, 0, 0);
...
#ifdef CONFIG_BATTERY_CW2015
		cw2015_pdata.data_tbl = cw2015_anran8100_tb610n_config_info;
