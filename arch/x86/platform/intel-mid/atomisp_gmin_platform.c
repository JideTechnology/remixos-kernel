...
static const struct gmin_cfg_var cht_vars[] = {
	{ "INT3477:00_CsiPort",  "1" },
	{ "INT3477:00_CsiLanes", "4" },
	{ "INT3477:00_CamClk",   "0" },
	{ "INT3477:00_ClkSrc",   "0" },
	...
	{ "GCTI2355:00_CsiLanes", "1" },
	{ "GCTI2355:00_CamClk",   "1" },
	{ "GCTI2355:00_ClkSrc",   "0" },
	{ "INT5040:00_CsiPort",  "1" },
	{ "INT5040:00_CsiLanes", "2" },
	{ "INT5040:00_CamClk",   "0" },
	{ "INT5040:00_ClkSrc",   "0" },
	{},
};
...
int gmin_get_config_var(struct device *dev, const char *var, char *out, size_t *out_len)
{
	...
	for (i = 0; i < ARRAY_SIZE(hard_vars); i++) {
		if (!strcmp(hard_vars[i].dmi_board_name, "UNICAM")) {
