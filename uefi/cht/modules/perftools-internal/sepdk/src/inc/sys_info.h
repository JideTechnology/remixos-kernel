...
#define  KNC_FAMILY         0x0b
#define  KNC_MODEL          0x01
#define  KNL_FAMILY         0x06
#define  KNL_MODEL          0x57

#define is_MIC_Supported(family, model)       (((family==KNC_FAMILY)&&(model==KNC_MODEL)) || ((family==KNL_FAMILY)&&(model==KNL_MODEL)))
