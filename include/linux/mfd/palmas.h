...
struct palmas {
	...
	struct palmas_pwrbutton *pwrbutton;
...
struct palmas_pwrbutton_platform_data {
...
#define ID_OTG_IRQ_FLAG   0x0001
#define ID_IRQ_FLAG       0x0002
#define VBUS_OTG_IRQ_FLAG 0x0004
#define VBUS_IRQ_FLAG     0x0008
...
extern int palmas_powerkey_state(void);
extern void palmas_disable_irq_work(int mask);
...
extern void palmas_power_off(void);
