...
struct flashlight_ops {
    int (*set_movie_brightness)(struct flashlight_device *, int);
    int (*set_flash_brightness)(struct flashlight_device *, int);
    int (*set_flash_timeout)(struct flashlight_device *, int);
    int (*list_flash_timeout)(struct flashlight_device *, int);
    ...
    int (*flash_charge)(struct flashlight_device *,
                         flashlight_charge_event_cb, void *, int);
    int (*flash)(struct flashlight_device *, int);
...
extern int flashlight_set_color_temperature(
                        struct flashlight_device *flashlight_dev,
                        int minK, int maxK);
extern int flashlight_set_movie_brightness(
                        struct flashlight_device *flashlight_dev,
                        int brightness_level);
extern int flashlight_set_flash_brightness(
                        struct flashlight_device *flashlight_dev,
                        int brightness_level);
extern int flashlight_list_flash_timeout(
                        struct flashlight_device *flashlight_dev,
                        int selector);
extern int flashlight_set_flash_timeout(
                        struct flashlight_device *flashlight_dev,
 ...
 */
extern int flashlight_flash_charge(struct flashlight_device *flashlight_dev,
                        flashlight_charge_event_cb cb, void *data, int start);
